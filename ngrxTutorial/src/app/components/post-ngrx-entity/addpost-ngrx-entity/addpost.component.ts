...
import { AddPostNeAction } from '../state-ngrx-entity/post.actions';
...
export class AddpostNeComponent implements OnInit{
...
onAddFormSubmit(){
  ...
  this.storeService.dispatch(AddPostNeAction({post: postData}))

...
import { UpdatePostNeAction } from '../state-ngrx-entity/post.actions';
import { getPostStateByIdSelector } from '../state-ngrx-entity/post.selector';
...
export class EditpostNeComponent implements OnInit, OnDestroy{
constructor(
...
onAddFormSubmit(){
  ...
  this.store.dispatch(UpdatePostNeAction({post: updatedPostData}))
